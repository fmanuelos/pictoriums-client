...
const pictoriums = require('../')
const fixtures = require('./fixtures')

let options = {
  endpoints: {
    pictures: 'http://pictoriums.test/picture',
    users: 'http://pictoriums.test/user',
    auth: 'http://pictoriums.test/auth'
  }
}

test.beforeEach(t => {
  t.context.client = pictoriums.createClient(options)
})
